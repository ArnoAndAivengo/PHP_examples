...
<style>
  ...
  <body>
    ...
    <div class="container">
		...
		<input type="text" class="form-control" name="S" placeholder="размер кредита">
		</div>
		</div>	
		
		<div class="row">
		<div class="form-group">
		<input type="text" class="form-control" name="p" placeholder="годовая процентная ставка">
		</div>
		</div>
		
		<div class="row">
		<div class="form-group">
		<input type="text" class="form-control" name="n" placeholder="количество лет">
		</div>
		</div>
