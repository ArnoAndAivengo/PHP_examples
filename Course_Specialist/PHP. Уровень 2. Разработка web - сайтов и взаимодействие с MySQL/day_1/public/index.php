...
//Установили счетчик посещений и время последнего посещения
...
$str = "$url|$from|$time|\r\n";
file_put_contents("log.log",$str,FILE_APPEND);
