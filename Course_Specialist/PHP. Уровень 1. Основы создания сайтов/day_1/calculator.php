...
<style>
  ...
  <body>
    ...
    <p class="bg-success">Переплата: <?= round($n * $A - $S) ?></p>
		...
		<div class="row">
		<div class="form-group">
		<input type="text" class="form-control" name="p" value="<?= $p * 1200 ?>" placeholder="годовая процентная ставка">
		</div>
		</div>
		
		<div class="row">
		<div class="form-group">
		<input type="text" class="form-control" name="n" value="<?= $n / 12 ?>" placeholder="количество лет">
		</div>
		</div>
